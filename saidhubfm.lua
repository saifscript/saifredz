...
local redzlib = {
	Themes = {
		Darker = {
			...
			["Color Stroke"] = Color3.fromRGB(0, 191, 255), -- Light Blue Neon
			["Color Theme"] = Color3.fromRGB(0, 120, 255), -- Blue Accent
			["Color Text"] = Color3.fromRGB(235, 235, 255),
			["Color Dark Text"] = Color3.fromRGB(160, 160, 200)
		},

		Dark = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30, 30, 30)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(38, 38, 38)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(30, 30, 30))
			}),
			["Color Hub 2"] = Color3.fromRGB(35, 35, 35),
			["Color Stroke"] = Color3.fromRGB(255, 70, 70), -- Red border
		...
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(35, 0, 50)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(45, 10, 60)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(35, 0, 50))
			}),
			["Color Hub 2"] = Color3.fromRGB(40, 10, 60),
			["Color Stroke"] = Color3.fromRGB(200, 0, 255),
			["Color Theme"] = Color3.fromRGB(160, 0, 255),
			["Color Text"] = Color3.fromRGB(255, 230, 255),
			["Color Dark Text"] = Color3.fromRGB(180, 130, 200)
		}
	}
}
	Info = {
